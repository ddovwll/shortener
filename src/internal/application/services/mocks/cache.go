...
// Source: src/internal/application/contracts/cache.go
//
// Generated by this command:
//
//	mockgen -source=src/internal/application/contracts/cache.go -package=mocks -destination=src/internal/application/services/mocks/cache.go
//
